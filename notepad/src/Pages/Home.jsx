...
const Home = () => {
  ...
  return (
    <div className="homeOperation">
      <Menu secondary>
        <MenuItem> <Select placeholder='Sort by title' options={sortOptions} /></MenuItem>
        <MenuItem><Input icon='search'placeholder='Search notes...' /></MenuItem>
        <MenuItem><Select placeholder='Filter by category' options={filterOptions} /></MenuItem>
      </Menu>
    </div>
  );
};
